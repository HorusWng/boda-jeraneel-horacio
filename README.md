# Invitación Boda — Jeraneel & Horacio

Este repositorio contiene una invitación web lista para publicarse en **GitHub Pages**.
...
6. Tu sitio quedará público en: `https://<tu-usuario>.github.io/<repo>/`.
